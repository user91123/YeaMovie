import { useGetPopularSerials2025Query } from "@/05_entities/movie/api/moviesApi";
import styles from "./styles.module.css";
import { MovieCard } from "@/05_entities/movie/ui";

export const PopularSerials = () => {
  const { data, isLoading, error } = useGetPopularSerials2025Query();
  ...
  return (
    <div className={styles.popularSerialsList}>
      {data?.docs.map((movie) => {
